...
// Entry
$_['entry_merchant']     = 'ID-ul de Autentificare:';
$_['entry_key']          = 'Codul Tranzacției:';
$_['entry_callback']     = ' URL-ul de răspuns:<br /><span class="help">Vă rugăm să vă autentificați și să setați asta la <a href="https://secure.authorize.net" target="_blank" class="txtLink">https://secure.authorize.net</a>.</span>';
...
// Error 
$_['error_permission']   = 'Atenție: Nu aveți permisiunea să modificați plata prin Authorize.Net (SIM)!';
$_['error_merchant']     = 'ID-ul Comerciantului este necesar!';
$_['error_key']          = 'Codul Tranzacției este necesar!';
?>