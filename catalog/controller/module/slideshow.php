...
class ControllerModuleSlideshow extends Controller {
	protected function index($setting) {
		...
		$this->document->addScript('catalog/view/javascript/jquery/banner-rotator/js/jssor.slider-21.1.6.min.js');
		$this->document->addScript('catalog/view/javascript/jquery/full-width-slider/js/jssor.slider-21.1.6.min.js');
