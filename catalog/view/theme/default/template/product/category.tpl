...
-->
 ...
 <div style="padding: 20px 40px 60px 40px; background-color: rgba(255, 255, 255, 0.5);">
...
<!--
      <img
          ...
          onmouseover="this.src='<?php echo str_replace('.jpg', '-back.jpg', $product['thumb']);?>'"
          onmouseout="this.src='<?php echo $product['thumb'];?>'"
